...
int main(int argc, char** argv) {
    ...
    int dev = FIXME; // Use this processes's 0-indexed rank also as its 0-based device ID.
    cudaSetDevice(dev);
    ...
    *hits = 0;
    ...
    calculate_pi<<<blocks, threads_per_block>>>(d_hits, FIXME); // The kernel expects a device ID integer passed as its second argument.
